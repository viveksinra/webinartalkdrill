    ...
    <footer className="border-t border-black/10 bg-white">
      <Container className="py-6 flex flex-col items-center justify-between gap-4 text-sm text-black/70 sm:flex-row">
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          <a href="https://x.com/TalkdrillApp" aria-label="X (Twitter)" className="group rounded-full p-2 ring-1 ring-black/10 hover:bg-black/5">
          ...
          <a href="https://www.linkedin.com/company/talkdrill" aria-label="LinkedIn" className="group rounded-full p-2 ring-1 ring-black/10 hover:bg-black/5">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4 text-black/70 group-hover:text-black">
          ...
          <a href="https://www.instagram.com/talkdrill/" aria-label="Instagram" className="group rounded-full p-2 ring-1 ring-black/10 hover:bg-black/5">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4 text-black/70 group-hover:text-black">
          ...
          <a href="https://t.me/talkdrill" aria-label="Telegram" className="group rounded-full p-2 ring-1 ring-black/10 hover:bg-black/5">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4 text-black/70 group-hover:text-black">
              <path d="M11.944 0C5.347 0 0 5.347 0 11.944s5.347 11.944 11.944 11.944 11.944-5.347 11.944-11.944S18.54 0 11.944 0zm5.503 8.355l-2.09 9.86c-.158.697-.567.87-1.148.541l-3.169-2.336-1.528 1.472c-.169.169-.31.31-.635.31l.226-3.199 5.823-5.263c.253-.226-.055-.352-.391-.127l-7.204 4.536-3.104-.97c-.673-.212-.687-.673.141-.996l12.128-4.683c.568-.211 1.065.127.882.951z"/>
            </svg>
          </a>
          <a href="https://www.youtube.com/@talkdrill" aria-label="YouTube" className="group rounded-full p-2 ring-1 ring-black/10 hover:bg-black/5">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4 text-black/70 group-hover:text-black">
          ...
          <a href="https://www.facebook.com/profile.php?id=61576040686850" aria-label="Facebook" className="group rounded-full p-2 ring-1 ring-black/10 hover:bg-black/5">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4 text-black/70 group-hover:text-black">
